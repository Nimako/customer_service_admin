            ...
            <div class="row">
                    ...
                    <div class="card recent-leads">
                        ...
                        <div class="card-body">
                            <div class="media mt-0 pt-0 mb-5">
                                <img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset("images/users/2.jpg")}} alt="image">
                            ...
                            <div class="media mb-5">
                                <img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset("images/users/11.jpg")}} alt="image">
                                <div class="media-body">
                            ...
                            <div class="media mb-5">
                                <img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset("images/users/5.jpg")}} alt="image">
                                <div class="media-body">
                            ...
                            <div class="media mb-5">
                                <img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset("images/users/12.jpg")}} alt="image">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset("images/users/6.jpg")}} alt="image">
                                <div class="media-body">
                ...
                <div class="col-lg-6 col-xl-4 col-sm-12">
                    <div class="card overflow-hidden">
                        <div class="">
                            <div class="text-center">
                                <img src="{{ asset("images/media/project-1.jpg")}} alt="img" class="h-200 w-100">
                            </div>
                            <div class="mt-3">
